...
public class DataGenInputFormat extends InputFormat<LongWritable, NullWritable> {
     ...
     */
    static class DataGenInputSplit extends InputSplit implements Writable {
        long firstRow;
        long rowCount;

        public DataGenInputSplit() {
        }

        public DataGenInputSplit(long offset, long length) {
            firstRow = offset;
            rowCount = length;
        }
     ...
     */
    static class DataGenRecordReader
        ...
        public DataGenRecordReader() {
        }

        public void initialize(InputSplit split, TaskAttemptContext context)
                throws IOException, InterruptedException {
            startRow = ((DataGenInputSplit) split).firstRow;
            finishedRows = 0;
            totalRows = ((DataGenInputSplit) split).rowCount;
        }
    ...
    createRecordReader(InputSplit split, TaskAttemptContext context)
            throws IOException {
        return new DataGenRecordReader();
    }
