 ...
 */
package com.streever.iot.nifi.data.utility.processor;
...
@CapabilityDescription("This processor creates FlowFiles with random data or custom content base on a json definition. GenerateRecordProcessor is useful" +
